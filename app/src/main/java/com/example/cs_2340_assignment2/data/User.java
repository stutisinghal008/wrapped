    ...
    public class User implements Serializable {
        ...
        private final Collection<String> messages;  // message ids
        private final Collection<String> likes;  // message ids
        private final Collection<String> views;  // message ids
        private final Collection<String> followers;  // user ids
        private final Collection<String> following;  // user ids
